...
$query = $db->prepare("SELECT * FROM tlapangan");
$query->execute();
$data = $query->fetchAll();
?>
...
<html lang="en">
<head>
<title>Futsal Apps Admin - Lapangan</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Futsal Apps Admin - Lapangan</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="frame.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="lapangan.php" class="current">Lapangan</a> </div>
    <h1>Lapangan</h1>
  </div>
<div class="container-fluid">
  <hr>
  <div class="row-fluid">
    <a href="tambah-lapangan.php"><button class="btn btn-success"><i class="icon-plus"></i> &nbsp; Tambah Data</button></a>
         <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5>Semua Lapangan</h5></div>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <?php foreach ($data as $value): ?>
                  ...
                  <td><?php echo $value['lapangan'] ?></td>
                  <td><?php echo "Rp.".number_format($value['harga'],0,',','.')?></td>
                  <td class="center ">  
                    <a href="edit.php?id=<?php echo $value['id']?>"><button class="btn btn-primary"> <i class="icon-pencil"></i> &nbsp; Edit</button></a>
