...
<div class="logo">
	...
	<div class="tulisanlogin"><p class="tulisanlogin2">Untuk masuk ke menu Melamar Pekerjaan, Silahkan Login Terlebih Dahulu !</p></div>
	...
	<?php
		...
		if($_POST){
			...
			header("location: user/index.php");
				...
				$error['userandpass'] = 'Username atau Password Salah !'; 
				}
			}
		}
	?>
	...
	<form method="post" action="">
		...
		<tr>
			<td colspan=3 style="color: red; font-size: 13px; padding-left: 92px;"><?php echo isset($error['userandpass']) ? $error['userandpass'] : '';?></font></td>
		</tr>
		<tr>
			<td>Username</td>
			<td>: </td>
			<td><input class="inputlogin" type="text" name="username" autofocus onkeypress="return tolakSpasi(event)"></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="notice" colspan=3> Jika belum memiliki akun, silahkan daftar <a href="daftar.php">disini</a></td>
		</tr>
		</table>
	</form>
