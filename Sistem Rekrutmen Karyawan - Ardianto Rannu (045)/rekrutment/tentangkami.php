...
<div class="logo">
		...
		<div class="navbar">
			<div class="backgroundmenu">
				<div class="daftarmenu">
					...
					<li class="daftarmenu2"><i class="material-icons">info</i><a href="tentangkami.php">Tentang Kami</a></li>
	...
	<div class="body">
		<h2 class="word8">Tentang Kami</h2>
		<hr>
		<h2 class="word9">Rannu Digital Solution merupakan perusahaan pengembangan software yang melayani berbagai project infrastruktur IT, baik dari pemerintahan dan maupun swasta. Melalui perusahaan ini ratusan project telah diselesaikan dengan hasil yang memuaskan serta mendapatkan feedback yang sangat positif dari instansi. 
		<br>
		<br>Rannu Digital Solution didirikan sebagai Badan Usaha Khusus pengembangan software IT pada tahun 2019 melalui kolaborasi beberapa mahasiswa IT Untuk mendukung pengembangan teknologi digital di Indonesia. 
		<br>
		<br>Tujuan perusahaan saat ini berfokus pada pengaplikasian teknologi terbaru pada infrastruktur IT di Indonesia dengan biaya yang terjangkau. Hal ini dilakukan seiring dengan perkembangan dunia digital 4.0 yang mengarah kepada perpindahan teknologi dari konvensional ke digital. Untuk menurunkan biaya, perusahaan harus beroperasi lebih efisien dan produktif serta meningkatkan kapasitas untuk memanfaatkan adanya skala ekonomis.
		<br>
		<br>Sebagai perusahaan pengembang software, Rannu Digital Solution menyadari bahwa kegiatan operasi perusahaan memiliki dampak secara langsung terhadap user. Perusahaan menyadari bahwa aspek pendidikan sumber daya manusia di bidang IT harus ditingkatkan menjadi lebih baik lagi. Beranjak dari konsepsi ini maka perhatian yang mendalam terhadap upaya peningkatan sumber daya manusia menjadi sangat penting di era globalisasi saat ini, pengembangan sumber daya manusia secara proaktif merupakan salah satu kunci kesuksesan kegiatan peusahaan sampaisaat ini. </h2>
		<hr>
		<h2 class="word10">Visi</h2>
		<h2 class="word11">
		"Menjadi korporasi global terkemuka dalam bidang insfrastruktur IT"
		</h2>
		<hr>
		<h2 class="word12">Misi</h2>
		<h2 class="word13">
    	a. Menghasilkan software berkualitas dengan memaksimalkan teknologi yang ada <br>
	    b. Mengoptimalkan keamanan software demi kenyamanan user dan keamanan data 
		</h2>
	</div>
