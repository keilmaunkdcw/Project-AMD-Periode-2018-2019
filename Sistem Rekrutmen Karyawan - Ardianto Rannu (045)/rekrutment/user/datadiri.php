        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                ...
                <ul class="list">
                    ...
                    <li class="tombol-dbs1">
                        <a class="border-dsb" href="datadiri.php">
        ...
        <div class="row clearfix">
                        ...
                        <div class="body">
                                ...
                                <?php  
                                    ...
                                    $query = "SELECT * FROM peserta_rekrutment where id_username='".$id_user."' ";
                                    $sql = mysqli_query($koneksi, $query); 

                                    while($data = mysqli_fetch_assoc($sql)){ 
                                        echo "<div>";
                                        echo "<img src='images/".$data['gambar']."' class='foto' width='100' height='110' >";
                                        echo "</div>";

                                        echo "<p><b> Biodata Peserta </b></p>";
                                        echo "<hr>";

                                echo "<div class='isiprofil'>";
                                    echo "<div class='profilkiri'>";
                                        echo "<div>";
                                        ...
                                        echo "<div class='tgllahir'>".$data['tgllahir']."</div>";
                                        echo "</div>";

                                        echo "<div>";
                                        echo "<label>Jenis Kelamin :</label>";  
                                        echo "<div class='jkl'>".$data['jkel']."</div>";    
                                        echo "</div>";

                                        echo "<div>";
                                        echo "<label>Email :</label>";
                                        echo "<div class='email'>".$data['email']."</div>";
                                        echo "</div>";
                                    echo "</div>";

                                    echo "<div class='profilkanan'>";
                                        echo "<div>";
                                        echo "<label>NIK :</label>";
                                        echo "<div class='nik'>".$data['nik']."</div>";
                                        echo "</div>";

                                        echo "<div>";
                                        echo "<label>No. Handphone :</label>";  
                                        echo "<div class='nohp'>".$data['nohp']."</div>";
                                        echo "</div>";
                                        ...
                                        echo "<div class='agama'>".$data['agama']."</div>";    
                                        echo "</div>";
                                    echo "</div>";
                                echo "</div>";  
                                echo "<hr>";
