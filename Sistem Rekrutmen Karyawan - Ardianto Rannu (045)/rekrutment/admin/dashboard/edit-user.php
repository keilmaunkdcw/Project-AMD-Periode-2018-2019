        ...
        <div class="container-fluid">
            <div class="block-header">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="header">
                            <h2 class="word2">Form Edit User <br>PT. Rannu Digital Solution</h2>
                        </div>
                        <div class="body">
                ...
                <?php
                    include 'koneksi.php';
                        ...
                        if(isset($_POST['submit'])) {
                            ...
                            $error = array();
                            $query  = "update user set username='$username', password='$password' where id = '$edit' ";
                        ...
                        <form method="post" action="">
                            <table class="login" border=0 align="center" cellpadding=5 cellspacing=0>
                                ...
                                <td>: </td>
                                <td><input class="input" type="text" name="username" onkeypress="return tolakSpasi(event)" value="<?php echo $data['username'] ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <td>Password</td>
                                <td> : </td>
                                <td><input class="input" type="text" name="password" value="<?php echo $data['password'] ?>"></td>
                                </tr>
                                <tr>
