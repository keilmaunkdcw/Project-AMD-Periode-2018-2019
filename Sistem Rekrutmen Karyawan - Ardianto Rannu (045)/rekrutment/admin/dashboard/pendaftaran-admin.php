        ...
        <div class="container-fluid">
            <div class="block-header">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="header">
                            <h2 class="word2">Form Pendaftaran Admin <br>PT. Rannu Digital Solution</h2>
                        </div>
                        <div class="body">
                    ...
                    if($_POST){
                        ...
                        if (mysql_num_rows($prosescek)>0) { //proses mengingatkan data sudah ada
                            $error['admin_terdaftar'] = 'Nama Admin Sudah Terdaftar !';
                                ...
                                $daftar = mysql_query("INSERT INTO admin (nama_admin,password,tgl_lahir) values ('$nama_admin','$password','$tgl_lahir')");
                ...
                ?>
                        ...
                        <form method="post" action="">
                            <table class="login" border=0 align="center" cellpadding=5 cellspacing=0>
                                ...
                                <td>: </td>
                                <td><input class="input" type="text" name="nama_admin" ></td>
                                </tr>
                                <tr>
                                ...
                                <td>Tanggal Lahir</td>
                                <td> : </td>
                                <td><input class="input" type="date" name="tgl_lahir"></td>
                                </tr>
