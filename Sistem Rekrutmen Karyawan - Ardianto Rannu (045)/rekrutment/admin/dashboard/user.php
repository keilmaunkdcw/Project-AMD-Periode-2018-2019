        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="header">
                            <h2 class="word2">Daftar User <br>PT. Rannu Digital Solution</h2>
                        </div>
                        <div class="body">
                        <a style="text-decoration: none; " class="tambah1" href="pendaftaran-user.php">+Tambah User</a>
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="edit-user.php?<?php echo 'edit=' .$data['id'] ?>"><i class="material-icons">edit</i></a>
                                    <a href="hapus-user.php?<?php echo 'hapus=' .$data['id'] ?>"><i class="material-icons">delete</i></a>
                                    </td>
                                </tr>
