...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/tatacara.css" >
...
<div class="logo">
		...
		<div class="navbar">
			<div class="backgroundmenu">
				<div class="daftarmenu">
					...
					<li class="daftarmenu2"><i class="material-icons">info</i><a href="tatacararekrutmen.php">Tata Cara Rekrutmen</a></li>
	...
	<div class="body">
		<h2 class="word8">Tata Cara Melamar</h2>
		<hr>
			<table class="line1">
				<tr>
					<td class="tulisanline1"><h1 class="nomor">1. </h1>Pelamar hanya dapat melamar melalui situs web https://rannudigitalsolution.com/rekrutmen dengan mengikuti petunjuk pendaftaran. Tidak ada jalur lain yang digunakan untuk pengiriman lamaran. </td>
					
					<td class="tulisanline1"><h1 class="nomor">2. </h1>Pelamar wajib memiliki alamat e-mail pribadi dan nomor telepon seluler yang masih aktif untuk dapat mengikuti proses seleksi ini. Tidak ada layanan untuk perubahan/ koreksi alamat e-mail dan nomor telepon seluler yang telah diinput oleh pelamar. </td>

					<td class="tulisanline1"><h1 class="nomor">3. </h1>Pelamar dilarang menggunakan alamat e-mail milik orang lain dalam proses pendaftaran.</td>
				</tr>
			</table>

					<div class="tulisanline2"><h1 class="nomor2">4. </h1><p>Untuk memudahkan registrasi online, persiapkan terlebih dahulu beberapa dokumen ini. Data dan soft file (masing-masing file/ dokumen berukuran maksimum 1000kb / 1mb)<br> dari dokumen tersebut diperlukan untuk melengkapi form registrasi unggah dokumen sebagai berikut: <br>
   					1. E-KTP atau Surat Keterangan Perekaman E-KTP Asli<br>
   					2. Ijazah Asli/Copy Ijazah Legalisir S1<br>
   					3. Transkrip Nilai Ijazah S1<br>
 					</p>
 					</div>
					
					<div class="tulisanline2"><h1 class="nomor3">5. </h1><br><p>Pelamar diwajibkan menyiapkan <b>soft file pas foto terbaru</b> (maksimum 3 bulan terakhir), format JPG dengan ukuran file maksimum 100kb. 
 					</p>
 					</div>
 			<table class="line1">
				<tr>
					<td class="tulisanline1"><h1 class="nomor">6. </h1>Batas akhir unggah dokumen yang dipersyaratkan 01 januari 2222 sampai dengan pukul 23.59 WITA. </td>
					
					<td class="tulisanline1"><h1 class="nomor">7. </h1>Aplikasi yang masuk setelah batas akhir registrasi ( 01 januari 2222 ) sampai dengan pukul 23.59 WITA) dan/ atau tidak melamar secara online, dianggap tidak berlaku. </td>

					<td class="tulisanline1"><h1 class="nomor">8. </h1>Jadwal kegiatan dan tanggal pengumuman hasil seleksi setiap tahap dapat dilihat pada pengumuman</td>
				</tr>
			</table>
	</div>
