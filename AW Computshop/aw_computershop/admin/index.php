...
<!-- <a href="login.html" class="btn btn-danger square-btn-adjust">Logout</a> -->
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li><a href="index.php?halaman=produk"><i class="fa fa-bar-chart fa-2x"></i> Produk</a></li>
                <li><a href="index.php?halaman=pembelian"><i class="fa fa-tasks fa-2x"></i> Pembelian</a></li>
